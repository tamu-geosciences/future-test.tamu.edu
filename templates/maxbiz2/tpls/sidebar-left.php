...
<body id="sidebar-left" class="<?php $this->bodyClass() ?>">
		...
		<div id="gradient">
			<div class="zen-container">
				<div class="gradient-inner">
					<div class="row-fluid">
						<div id="main-area" class="<?php if ($this->checkSpotlight('sidebar', 'sidebar-2')) { ?>span8 pull-right<?php } else { ?>span12<?php } ?>">
						...
						<div id="side" class="span4 pull-left">
							<div id="main-side">
								<!-- SIDEBAR 2 -->
								<div id="sidebar-main" class="sidebar sidebar-2 <?php echo $this->getClass($layout, $col) ?> affix-top">
