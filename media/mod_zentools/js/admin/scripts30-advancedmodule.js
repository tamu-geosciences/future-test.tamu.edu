...
jQuery(function() {
	...
	text = "li a[href=#options-text]";
	image = "li a[href=#options-imageresize]";
	accordionPanel = "li a[href=#options-accordion]";
	slideshowPanel = "li a[href=#options-slideshow]";
	imageResizePanel = "li a[href=#options-imageresize]";
	gridPanel = "li a[href=#options-grid]";
	carouselPanel = "li a[href=#options-carousel]";
	filterPanel = "li a[href=#options-filter]";
	masonryPanel = "li a[href=#options-masonry]";
	panelcontent = "li a[href=#options-content]";
	panelk2 = "li a[href=#options-K2]";
	titlePanel = "li a[href=#options-title]";
	more = "li a[href=#options-readmore]";
	date = "li a[href=#options-date]";
	columnwidthPanel = "li a[href=#options-columnwidth]";
	lightboxpanel = "li a[href=#options-fancybox]";
	imageSourcePanel = "li a[href=#options-imageDirectory]";
	pagination= "li a[href=#options-pagination]";
	twitterPanel = "li a[href=#options-twitter]";
	...
	window.setContentSource = function()
	{
		...
		else
		{
			...
			else if (jQuery(k2Source).is(':selected'))
			{
